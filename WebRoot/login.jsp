...
<head>
    ...
    {
	   margin-left: 0px;
	   background-image: url(<%=path %>/WebRoot/img/bhj.gif);
    }
    .style2 {color: #990000}
    .input2 
    {
...
/*	.admin{
		background-image: url("<%=path %>/img/bgp.gif");
	}*/
...
<body class="admin">
	...
	<table width="559" height="423" border="0" align="center" cellpadding="0" cellspacing="0"  background="<%=path %>/img/dfff.jpg">
	 <tr>
	    <td><div align="center" style="FONT-WEIGHT: bold; FONT-SIZE: 33pt;">花之苑</div></td>
	 </tr>
	 <tr>
		<td width="559">
