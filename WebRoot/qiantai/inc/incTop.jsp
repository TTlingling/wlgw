...
<html>
  <head>
	  <title>花之苑</title>
	  <%--<link rel="icon" href="img/picture.ico" type="image/x-icon"/>--%>
	  <style type="text/css">
        .Header {background: url(<%=path %>/img/banner.jpg) #80d11e repeat-x left top; height: 70px;width: 966px;}
  ...
  <body>
        <div class="Header HeaderTop">
			...
			<font style="font-size: 40px;color: #fff9ff;font-weight: bolder;display: block;text-align: center;">花之苑</font>
		</div>
